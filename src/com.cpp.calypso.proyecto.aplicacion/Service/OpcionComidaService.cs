...
namespace com.cpp.calypso.proyecto.aplicacion.Service
{
        ...
        IOpcionComidaAsyncBaseCrudAppService
    {
        ...
        public IBaseRepository<OpcionComida> Repository { get; }
        ...
        public JArray GenerarRegistrosMovil(Dictionary<int, int> diccionario, List<OpcionComida> registros)
        {
        ...
        public Dictionary<int, int> SincronizacionLocal(JArray registrosJson)
        {
            ...
            foreach (JObject obj in registrosJson)
            {
                ...
                OpcionComida instancia = JsonToObject(obj);
        ...
        public List<OpcionComida> GetRegistros(int version, List<int> usuarios)
        {
        ...
        public JObject ObjectToJson(OpcionComida entidad)
        {
            ...
            objJson.Add("opcion_comida", entidad.Opcion);
            return objJson;
        }

        public OpcionComida JsonToObject(JObject json)
        {

            var entity = new OpcionComida();
            ...
            entity.Costo = (decimal)json.GetValue("costo");
            entity.Nombre = (string)json.GetValue("nombre");
            entity.Opcion = (int)json.GetValue("opcion_comida");
