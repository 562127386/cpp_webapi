...
namespace com.cpp.calypso.proyecto.aplicacion.Service
{
    public class RequisitoColaboradorAsyncBaseCrudAppService : AsyncBaseCrudAppService<RequisitoColaborador, RequisitoColaboradorDto, PagedAndFilteredResultRequestDto>, IRequisitoColaboradorAsyncBaseCrudAppService
    {
        ...
        public IBaseRepository<RequisitoColaborador> Repository { get; }
        ...
        public JArray GenerarRegistrosMovil(Dictionary<int, int> diccionario, List<RequisitoColaborador> registros)
        {
        ...
        public Dictionary<int, int> SincronizacionLocal(JArray registrosJson)
        {
            ...
            foreach (JObject obj in registrosJson)
            {
                ...
                RequisitoColaborador instancia = JsonToObject(obj);
        ...
        public List<RequisitoColaborador> GetRegistros(int version, List<int> usuarios)
        {
        ...
        public JObject ObjectToJson(RequisitoColaborador entidad)
        {
            ...
            objJson.Add("requisito_id", entidad.RequisitoId);
            objJson.Add("colaborador_id", entidad.ColaboradorId);
            objJson.Add("nombre_requisito", entidad.NombreRequisito);
            objJson.Add("obligatorio", entidad.Obligatorio ? 1 : 0);
            objJson.Add("fecha_caducidad", GetStringFromDateTime(entidad.FechaCaducidad));
            objJson.Add("cumple", entidad.Cumple ? 1 : 0);
        ...
        public RequisitoColaborador JsonToObject(JObject json)
        {

            var entity = new RequisitoColaborador();
            ...
            entity.RequisitoId = (int)json["requisito_id"];
            entity.NombreRequisito = (string)json["nombre_requisito"];
            entity.Obligatorio = (int)json["obligatorio"] == 1 ? true: false;
            entity.ColaboradorId = (int)json["colaborador_id"];
            entity.FechaCaducidad = GetDateTimeFromString((string)json["fecha_caducidad"]);
            entity.Cumple = (int)json["colaborador_id"] == 1 ? true : false;
