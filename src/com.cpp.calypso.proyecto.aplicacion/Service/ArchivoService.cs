...
namespace com.cpp.calypso.proyecto.aplicacion.Service
{
    ...
    {
        public IBaseRepository<Archivo> Repository { get; }

        public ArchivoAsyncBaseCrudAppService(
        ...
        public JArray GenerarRegistrosMovil(Dictionary<int, int> diccionario, List<Archivo> registros)
        {
        ...
        public Dictionary<int, int> SincronizacionLocal(JArray registrosJson)
        {
            ...
            foreach (JObject obj in registrosJson)
            {
                ...
                Archivo instancia = JsonToObject(obj);
        ...
        public List<Archivo> GetRegistros(int version, List<int> usuarios)
        {
        ...
        public JObject ObjectToJson(Archivo entidad)
        {
        ...
        public Archivo JsonToObject(JObject json)
        {
