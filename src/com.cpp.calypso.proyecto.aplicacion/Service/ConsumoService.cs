...
namespace com.cpp.calypso.proyecto.aplicacion.Service
{
        ...
        PagedAndFilteredResultRequestDto>, IConsumoAsyncBaseCrudAppService
    {
        ...
        public List<Consumo> GetRegistros(int version, List<int> usuarios, Dictionary<int, int> diccionario)
        {
            ...
            var registros = Repository.GetAll()
                    ...
                    .Where(o => idEnMovil.Contains(o.Id) || DbFunctions.TruncateTime(o.Fecha) == fechaActual)
                    .ToList()
                ;
            return registros;
        }
