...
namespace com.cpp.calypso.proyecto.aplicacion.Service
{
    ...
    {
        public IBaseRepository<Ruta> Repository { get; }
        ...
        public JArray GenerarRegistrosMovil(Dictionary<int, int> diccionario, List<Ruta> registros)
        {
        ...
        public Dictionary<int, int> SincronizacionLocal(JArray registrosJson)
        {
            ...
            foreach (JObject obj in registrosJson)
            {
                ...
                Ruta instancia = JsonToObject(obj);
        ...
        public List<Ruta> GetRegistros(int version, List<int> usuarios)
        {
        ...
        public JObject ObjectToJson(Ruta entidad)
        {
            ...
            objJson.Add("origen_id", entidad.OrigenId);
            objJson.Add("destino_id", entidad.DestinoId);
            objJson.Add("distancia", entidad.Distancia);


            return objJson;
        }

        public Ruta JsonToObject(JObject json)
        {
            ...
            entity.OrigenId = (int)json["origen_id"];
            entity.DestinoId = (int)json["destino_id"];
            entity.Distancia = (decimal)json["distancia"];
