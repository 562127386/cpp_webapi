...
{
    public class ServicioRolAsyncBaseCrudAppService : AsyncBaseCrudAppService<ServicioRol, ServicioRolDto, PagedAndFilteredResultRequestDto>, IServicioRolAsyncBaseCrudAppService
    {
        public ServicioRolAsyncBaseCrudAppService(
            IBaseRepository<ServicioRol> repository
            ) : base(repository)
        {
            Repository = repository;
        }

        public IBaseRepository<ServicioRol> Repository { get; }
        ...
        public JArray GenerarRegistrosMovil(Dictionary<int, int> diccionario, List<ServicioRol> registros)
        {
        ...
        public Dictionary<int, int> SincronizacionLocal(JArray registrosJson)
        {
            ...
            foreach (JObject obj in registrosJson)
            {
                ...
                ServicioRol instancia = JsonToObject(obj);
        ...
        public List<ServicioRol> GetRegistros(int version, List<int> usuarios)
        {
        ...
        public JObject ObjectToJson(ServicioRol entidad)
        {
        ...
        public ServicioRol JsonToObject(JObject json)
        {

            var entity = new ServicioRol();
