...
namespace com.cpp.calypso.proyecto.aplicacion.Service
{
    ...
    {
        public IBaseRepository<RutaHorario> Repository { get; }
        ...
        public JArray GenerarRegistrosMovil(Dictionary<int, int> diccionario, List<RutaHorario> registros)
        {
        ...
        public Dictionary<int, int> SincronizacionLocal(JArray registrosJson)
        {
            ...
            foreach (JObject obj in registrosJson)
            {
                ...
                RutaHorario instancia = JsonToObject(obj);
        ...
        public List<RutaHorario> GetRegistros(int version, List<int> usuarios)
        {
        ...
        public JObject ObjectToJson(RutaHorario entidad)
        {
            ...
            objJson.Add("ruta_id", entidad.RutaId);
            objJson.Add("horario", GetStringFromTimeSpan(entidad.Horario));


            return objJson;
        }

        public RutaHorario JsonToObject(JObject json)
        {

            var entity = new RutaHorario();
            ...
            entity.RutaId = (int)json["ruta_id"];
            entity.Horario = GetTimeSpanFromString((string)json["horario"]);
