...
{
    public class AccesoTemporalAsyncBaseCrudAppService : AsyncBaseCrudAppService<AccesoTemporal, AccesoTemporalDto, PagedAndFilteredResultRequestDto>, IAccesoTemporalAsyncBaseCrudAppService
    {
        public AccesoTemporalAsyncBaseCrudAppService(
            IBaseRepository<AccesoTemporal> repository
            ) : base(repository)
        {
            Repository = repository;
        }

        public IBaseRepository<AccesoTemporal> Repository { get; }
        ...
        public JArray GenerarRegistrosMovil(Dictionary<int, int> diccionario, List<AccesoTemporal> registros)
        {
        ...
        public Dictionary<int, int> SincronizacionLocal(JArray registrosJson)
        {
            ...
            foreach (JObject obj in registrosJson)
            {
                ...
                AccesoTemporal instancia = JsonToObject(obj);
        ...
        public List<AccesoTemporal> GetRegistros(int version, List<int> usuarios)
        {
        ...
        public JObject ObjectToJson(AccesoTemporal entidad)
        {
            ...
            objJson.Add("usuario_generador_id", entidad.UsuarioCreadorId);
        ...
        public AccesoTemporal JsonToObject(JObject json)
        {

            var entity = new AccesoTemporal();
            ...
            entity.UsuarioCreadorId = (int)json["usuario_generador_id"];
