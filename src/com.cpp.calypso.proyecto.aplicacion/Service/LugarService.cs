...
namespace com.cpp.calypso.proyecto.aplicacion.Service
{
    ...
    {
        public LugarAsyncBaseCrudAppService(IBaseRepository<Lugar> repository) : base(repository)
        {
            Repository = repository;
        }

        public IBaseRepository<Lugar> Repository { get; }
        ...
        public JArray GenerarRegistrosMovil(Dictionary<int, int> diccionario, List<Lugar> registros)
        {
        ...
        public Dictionary<int, int> SincronizacionLocal(JArray registrosJson)
        {
            ...
            foreach (JObject obj in registrosJson)
            {
                ...
                Lugar instancia = JsonToObject(obj);
        ...
        public List<Lugar> GetRegistros(int version, List<int> usuarios)
        {
        ...
        public JObject ObjectToJson(Lugar entidad)
        {
            ...
            objJson.Add("latitud", entidad.Latitud);
            objJson.Add("longitud", entidad.Longitud);
        ...
        public Lugar JsonToObject(JObject json)
        {

            var entity = new Lugar();
            ...
            entity.Descripcion = (string)json["descripcion"];
            entity.Latitud = (string)json["latitud"];
            entity.Longitud = (string)json["longitud"];
