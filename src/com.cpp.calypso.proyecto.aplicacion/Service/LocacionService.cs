...
namespace com.cpp.calypso.proyecto.aplicacion.Service
{
        ...
        PagedAndFilteredResultRequestDto>, ILocacionAsyncBaseCrudAppService
    {
        ...
        public IBaseRepository<Locacion> Repository { get; }
        ...
        public JArray GenerarRegistrosMovil(Dictionary<int, int> diccionario, List<Locacion> registros)
        {
        ...
        public Dictionary<int, int> SincronizacionLocal(JArray registrosJson)
        {
            ...
            foreach (JObject obj in registrosJson)
            {
                ...
                Locacion instancia = JsonToObject(obj);
        ...
        public List<Locacion> GetRegistros(int version, List<int> usuarios)
        {
        ...
        public JObject ObjectToJson(Locacion entidad)
        {
            ...
            objJson.Add("zona_id", entidad.ZonaId);
            return objJson;
        }

        public Locacion JsonToObject(JObject json)
        {

            var entity = new Locacion();
            ...
            entity.Codigo = (int)json["codigo"];
            entity.Nombre = (string)json["nombre"];
            entity.ZonaId = (int)json["zona_id"];
