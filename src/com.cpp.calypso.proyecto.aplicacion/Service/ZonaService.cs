...
namespace com.cpp.calypso.proyecto.aplicacion.Service
{
        ...
        IZonaAsyncBaseCrudAppService
    {
        ...
        public IBaseRepository<Zona> Repository { get; }
        ...
        public JArray GenerarRegistrosMovil(Dictionary<int, int> diccionario, List<Zona> registros)
        {
        ...
        public Dictionary<int, int> SincronizacionLocal(JArray registrosJson)
        {
            ...
            foreach (JObject obj in registrosJson)
            {
                ...
                Zona instancia = JsonToObject(obj);
        ...
        public List<Zona> GetRegistros(int version, List<int> usuarios)
        {
        ...
        public JObject ObjectToJson(Zona entidad)
        {
        ...
        public Zona JsonToObject(JObject json)
        {
